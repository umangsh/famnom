...
from nutrition_tracker.forms import RecipeForm


class RecipeFormSerializer(FormSerializer):
    """Recipe form serializer class."""
    ...
    def get_form(self, data: dict | None = None, **kwargs: Any) -> RecipeForm:
        ...
        kwargs.update(
            {
                ...
                "lrecipe": self.context.get("lrecipe"),
            }
        )
